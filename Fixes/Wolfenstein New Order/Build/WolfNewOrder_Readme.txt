...
===========================================================
Wolfenstein: The New Order - 3D Vision Patch. - v.3.19 Beta
===========================================================
...
- Make sure the game runs in FullscreenMode.
...
- Use "F" key to toggle to a convergence mode when AIMING. Press "Q" to toggle back! (Can be changed from the Ini file. Look for aleternative convergence).
...
- Some "surfaces"/texture flicker. This is a "normal" thing due to the innacuracy of the mathematical computations.
